...
extension LiveViewController: ToyBoxListener {
    ...
    func requiresFirmwareUpdate(for toy: Toy?) -> Bool {
        ...
        switch toy {
        case is SPRKToy:
            return appVersion < AppVersion(major: "7", minor: "21", build: nil)
        case is BB8Toy:
            return appVersion < AppVersion(major: "4", minor: "69", build: nil)
        case is R2D2Toy:
            return appVersion < AppVersion(major: "5", minor: "0", build: nil)
        case is BB9EToy:
            return appVersion < AppVersion(major: "5", minor: "0", build: nil)
        case is BoltToy:
            return appVersion < AppVersion(major: "4", minor: "0", build: "37")
        case is MiniToy:
            return appVersion < AppVersion(major: "12", minor: "33", build: "0")
    ...
    func showFirmwareUpdateViewController() {
        ...
        if type(of: self) == TemplateLiveViewController.self {
            ...
            firmwareUpdateViewController?.topGradientColor = UIColor(red: 15.0/255.0, green: 197.0/255.0, blue: 165.0/255.0, alpha: 1.0)
            firmwareUpdateViewController?.bottomGradientColor = UIColor(red: 40.0/255.0, green: 159.0/255.0, blue: 224.0/255.0, alpha: 1.0)
        }
