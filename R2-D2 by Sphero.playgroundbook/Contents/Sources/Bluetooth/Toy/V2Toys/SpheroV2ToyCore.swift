...
class SpheroV2ToyCore: NSObject, CBPeripheralDelegate {
    ...
    lazy private var commandSequencer: CommandSequencerV2 = CommandSequencerV2()
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        if dfuControlCharaceristic != nil && dfuInfoCharaceristic != nil && antiDoSCharacteristic != nil && commandsCharacteristic != nil {
            peripheral.writeValue("usetheforce...band".data(using: String.Encoding.ascii)!, for: antiDoSCharacteristic, type: .withResponse)
        }
    }
